...
export const env = {
  ...
  AI_API_KEY: getEnvVar('GEMINI_API_KEY', false) || getEnvVar('AI_API_KEY', false),
  GEMINI_API_KEY: getEnvVar('GEMINI_API_KEY', false) || getEnvVar('AI_API_KEY', false),
  GEMINI_MODEL: getEnvVar('GEMINI_MODEL', false, 'gemini-2.0-flash'),
